                            ...
                            <table id="basic-datatables" class="display table table-striped table-hover" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-toggle="modal" data-target="#konfirmasi_hapus" data-href="{{ route('petugasDelete', $res->id) }}" class="btn btn-danger btn-sm"><span style="color:#fff;"><i class="far fa-trash-alt"></i></span></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('petugasSave') }}" enctype="multipart/form-data">
                @csrf
                    <div class="row">
...
<div class="modal fade" id="addRowModal2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
		...
		$(document).on('click', '.edit', function(e){
			...
			var id = $(this).attr('id');
			$.ajax({
				url: "{{ url('pengguna/petugas/getDataEdit') }}/"+id,
				dataType: "JSON",
				success:function(data){
					if(data != ""){
						...
						$('#openModalEdit').click();
						$('#FormEditPetugas').attr("action", "{{ url('pengguna/petugas/prosesEdit') }}/"+id);
					}
				}
			})
		})
